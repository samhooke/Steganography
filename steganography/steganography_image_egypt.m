...
[imc_stego, key1, key2, im_wavelet_stego, im_wavelet_secret] = steg_egypt_encode(imc_carrier, im_secret, mode, block_size);
im_stego = im_carrier;
...
[im_extracted, im_errors] = steg_egypt_decode(imc_stego, im_secret_width, im_secret_height, key1, key2, mode, block_size);
