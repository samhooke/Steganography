...
output_image_filename = [dir_output, 'lena_egypt_img.jpg'];
...
% Set to false, because we are encoding a secret image, not binary data
is_binary = false;
...
[im_extracted, im_errors] = steg_egypt_decode(imc_stego, im_secret_width, im_secret_height, key1, key2, mode, block_size, is_binary);
